...
for idx, stock_item in enumerate(xueqiu_stock_list.stock_list):
    ...
    print('guoren url:' + guoren_api.get_req_url())
    guoren_data = guoren_api.get_req_data().encode("utf8")
    print('guoren_data:' + guoren_api.get_req_data())
